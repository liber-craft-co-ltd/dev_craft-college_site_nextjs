  ...
  return (
    <Layout>
      <main id="commercial-transactions">
        <h1 className="heading_1 pb-20">特定商取引法に基づく表示</h1>
        <h2>事業者の名称</h2>
        <div className="content">株式会社リベルクラフト</div>
        <h2>事業責任者の氏名</h2>
        <div className="content">三好大悟</div>
        <h2>住所</h2>
        <div className="content">東京都千代田区内神田三丁目3番14</div>
        <h2>電話番号</h2>
        <div className="content">
          メールアドレスあてにお問い合わせを頂きましたら速やかに開示いたします。
        </div>
        <h2>メールアドレス</h2>
        <div className="content">daigo.miyoshi@liber-craft.co.jp</div>
        ...
        <div className="enachment-revision-date">2022年07月01日 制定</div>
      </main>
    </Layout>
  );
}
